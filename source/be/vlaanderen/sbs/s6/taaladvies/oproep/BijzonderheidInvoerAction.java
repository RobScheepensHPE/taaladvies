...
public class BijzonderheidInvoerAction extends BaseAction {
	...
	public ActionForward performAction(ActionMapping mapping,	ActionForm form, HttpServletRequest request, HttpServletResponse response)
		...
		//boolean check = false;
		BijzonderheidInvoerForm referenceForm = (BijzonderheidInvoerForm)form;
		...
		if (request.getParameter("Button") != null) {
			/*check = */Taalvraag.updateBijzonderheid(taalvraag);
