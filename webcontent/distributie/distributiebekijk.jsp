...
<body>
<h2>Distributie bekijk</h2>
<html:form method="post" action="/distributiekeuze">
	<table width="100%">
		<tr>
			<td width="15%"><b>Aan </b></td>
			<td width="35%"><bean:write name="DistributiekeuzeForm" property="oproep.email" /></td>
			<td width="15%"><b>Fax </b></td>
			<td width="35%"><bean:write name="DistributiekeuzeForm" property="oproep.fax" /></td>
		</tr>
		<tr>
			<td><b>CC </b></td>
			<td><bean:write name="DistributiekeuzeForm" property="oproep.distributie.cc" /></td>
			<td><b>BCC </b></td>
			<td><bean:write name="DistributiekeuzeForm" property="oproep.distributie.bcc" /></td>
		</tr>
		<tr>
			<td><b>Onderwerp </b></td>
			<td colspan="3"><bean:write name="DistributiekeuzeForm" property="oproep.distributie.sjabloon.onderwerp" /></td>
		</tr>
	</table>
	
	<p>
		<logic:notPresent name="DistributiekeuzeForm" property="oproep.distributie.sjabloon.aanspreking">
			<logic:equal name="DistributiekeuzeForm" property="oproep.naam" value="Onbekend">
				<logic:equal name="DistributiekeuzeForm" property="oproep.geslacht" value="o">
					Geachte heer, 
					<br>
					Geachte mevrouw, 
				</logic:equal>
				<logic:equal name="DistributiekeuzeForm" property="oproep.geslacht" value="m">
					Geachte heer, 
				</logic:equal>
				<logic:equal name="DistributiekeuzeForm" property="oproep.geslacht" value="v">
					Geachte mevrouw, 
				</logic:equal>
			</logic:equal>
			<logic:equal name="DistributiekeuzeForm" property="oproep.naam" value="">
				<logic:equal name="DistributiekeuzeForm" property="oproep.geslacht" value="o">			
					Geachte heer, 
					<br>
					Geachte mevrouw, 
			...
			<logic:notEqual name="DistributiekeuzeForm" property="oproep.naam" value="Onbekend">
				<logic:notEqual name="DistributiekeuzeForm" property="oproep.naam" value="">
					<logic:equal name="DistributiekeuzeForm" property="oproep.geslacht" value="m">
						Geachte heer 
					</logic:equal>
					<logic:equal name="DistributiekeuzeForm" property="oproep.geslacht" value="v">
		...
		<logic:present name="DistributiekeuzeForm" property="oproep.distributie.sjabloon.aanspreking">
			<bean:write name="DistributiekeuzeForm" property="oproep.distributie.sjabloon.aanspreking" filter="false" />
		</logic:present>
	</p>
	
	<p><bean:write name="DistributiekeuzeForm" property="oproep.distributie.sjabloon.inhoudHTML" filter="false" /></p>
	
	<p><bean:write name="DistributiekeuzeForm" property="oproep.distributie.sjabloon.slotgroetHTML" filter="false" /></p>
	
	<p>
		<bean:write name="DistributiekeuzeForm" property="oproep.gebruiker.voornaam" /> <bean:write name="DistributiekeuzeForm" property="oproep.gebruiker.naam" />
		<br />
		<bean:write name="DistributiekeuzeForm" property="oproep.distributie.sjabloon.handtekeningHTML" filter="false" />
	</p>
	...
	<p>
		<a href="../distributie/distributiekeuzeEKTRON.jsp">
			<img src="<html:rewrite page='/images/button_terug_naar_distributiekeuze.gif' />" border="0" />
		</a>
		<img src="../images/button_print.gif" border="0" onclick="javascript:window.location.href('distributiebekijk_dummy.jsp')" />
	</p>			
</html:form>
</body>
</html:html>