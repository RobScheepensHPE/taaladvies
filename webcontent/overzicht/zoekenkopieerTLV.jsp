...
<h2>Zoekfunctie Taalvraag Kopi&euml;ren</h2>
...
<html:form method="post" action="/zoekenKopieerTLV">
<bean:define name="SearchForm" property="relevanties" type="java.util.ArrayList" id="relevanties" />
                ...
                <table cellspacing="5" width="100%">
                    ...
                    <tr>
                        <td>Eigen taalvragen <html:checkbox property="eigenTV" /> | Andere taalvragen <html:checkbox property="alleTV" /></td>
                    </tr>
                    <tr>
                        <td>Taalvragen: titel <html:checkbox property="titel" /> | vraag <html:checkbox property="vraag" /> | antwoord <html:checkbox property="antwoord" /> | toelichting <html:checkbox property="toelichting" /> | bijzonderheid <html:checkbox property="bijzonderheid" /></td>
                    </tr>
					<tr>		
...
<table>	
	<logic:iterate name="SearchForm" property="categorieList"  id="cat" indexId="idx" >
		<tr>
			<td>
				<a href="javascript:doSubmit('../do/initGetCategorieForSearch?page=KPTLV&whichCategorie=<bean:write name="idx" />')" border="0"><html:img page="/images/button_categorienlijst.gif" border="0" /></a>
			</td>
			<td>
			...
			<td>
				<a href="javascript:doSubmit('../do/getCategorieForSearch?page=KPTLV&Verwijderen=true&whichCategorie=<bean:write name="idx" />')" border="0"><html:img page="/images/Delete24.gif" border="0" /></a>
			</td>
		</tr>
	</logic:iterate>
	<tr>
		...
		<td>
			<a href="javascript:doSubmit('../do/initGetCategorieForSearch?page=KPTLV&whichCategorie=<c:out value="${idx + 1}"></c:out>')" border="0"><html:img page="/images/button_categorienlijst.gif" border="0" /></a>
		</td>	
		<td>
			&nbsp;
		</td>
	...
	<tr>
 		<td colspan="2">Eigen taalvragen <html:checkbox property="eigenTV" /> | Andere taalvragen <html:checkbox property="alleTV" /></td>
	</tr>
	<tr>		
