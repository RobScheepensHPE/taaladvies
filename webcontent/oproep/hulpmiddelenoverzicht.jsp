...
<html:form method="post" action="/frequentiesInvoer">
	...
	<logic:present name="HulpmiddelenOverzichtForm" property="taalvraag">
			<a class="bigger" href="../do/initTaalvragenInvoer?id=<bean:write name="HulpmiddelenOverzichtForm" property="taalvraag.id" />">
	...
	<logic:present name="HulpmiddelenOverzichtForm" property="tekst">
			<a class="bigger" href="../do/initOproep_TekstInvoer?id=<bean:write name="HulpmiddelenOverzichtForm" property="tekst.oproepId" />">
		...
		<logic:present name="HulpmiddelenOverzichtForm" property="categorien">
			<tr>
				<td valign="top">
					<b>
						<logic:present name="HulpmiddelenOverzichtForm" property="taalvraag">
							<a href="../do/initCategorienInvoer?type=1&id=<bean:write name='HulpmiddelenOverzichtForm' property='taalvraag.id' />">
						</logic:present>
						<logic:present name="HulpmiddelenOverzichtForm" property="tekst">
							<a href="../do/initCategorienInvoer?type=2&id=<bean:write name='HulpmiddelenOverzichtForm' property='tekst.id' />">
						</logic:present>						
							Categorie   
						</a>		
					</b>
		...
		<logic:present name="HulpmiddelenOverzichtForm" property="naslagreferenties">
			<tr>
				<td valign="top">
					<b>
						<logic:present name="HulpmiddelenOverzichtForm" property="taalvraag">
							<a href="../do/initNaslagreferentiesInvoer?type=1&id=<bean:write name='HulpmiddelenOverzichtForm' property='taalvraag.id' />">
						</logic:present>
						<logic:present name="HulpmiddelenOverzichtForm" property="tekst">
							<a href="../do/initNaslagreferentiesInvoer?type=2&id=<bean:write name='HulpmiddelenOverzichtForm' property='tekst.id' />">
						</logic:present>						
							Naslagwerk   
						</a>
					</b>
		...
		<logic:present name="HulpmiddelenOverzichtForm" property="bronnen">
			<tr>
				<td valign="top">
					<b>
						<logic:present name="HulpmiddelenOverzichtForm" property="taalvraag">
							<a href="../do/initBronnenInvoer?type=1&id=<bean:write name='HulpmiddelenOverzichtForm' property='taalvraag.id' />">
						</logic:present>
						<logic:present name="HulpmiddelenOverzichtForm" property="tekst">
							<a href="../do/initBronnenInvoer?type=2&id=<bean:write name='HulpmiddelenOverzichtForm' property='tekst.id' />">
						</logic:present>								
							Bron  
						</a>
					</b>
		...
		<logic:present name="HulpmiddelenOverzichtForm" property="citaten">
			<tr>
				<td valign="top">
					<b>
						<logic:present name="HulpmiddelenOverzichtForm" property="taalvraag">
							<a href="../do/initCitatenInvoer?type=1&id=<bean:write name='HulpmiddelenOverzichtForm' property='taalvraag.id' />">
						</logic:present>
						<logic:present name="HulpmiddelenOverzichtForm" property="tekst">
							<a href="../do/initCitatenInvoer?type=2&id=<bean:write name='HulpmiddelenOverzichtForm' property='tekst.id' />">
						</logic:present>							
							Citaat  
						</a>
					</b>
		...
		<logic:present name="HulpmiddelenOverzichtForm" property="frequenties">
			<tr>
				<td valign="top">
					<b>
						<logic:present name="HulpmiddelenOverzichtForm" property="taalvraag">
							<a href="../do/initFrequentiesInvoer?type=1&id=<bean:write name='HulpmiddelenOverzichtForm' property='taalvraag.id' />">
						</logic:present>
						<logic:present name="HulpmiddelenOverzichtForm" property="tekst">
							<a href="../do/initFrequentiesInvoer?type=2&id=<bean:write name='HulpmiddelenOverzichtForm' property='tekst.id' />">
						</logic:present>							
							Frequentie   
						</a>
					</b>
		...
		<logic:present name="HulpmiddelenOverzichtForm" property="webreferenties">
			<tr>
				<td valign="top">
					<b>
						<logic:present name="HulpmiddelenOverzichtForm" property="taalvraag">
							<a href="../do/initWebreferentiesInvoer?type=1&id=<bean:write name='HulpmiddelenOverzichtForm' property='taalvraag.id' />">
						</logic:present>
						<logic:present name="HulpmiddelenOverzichtForm" property="tekst">
							<a href="../do/initWebreferentiesInvoer?type=2&id=<bean:write name='HulpmiddelenOverzichtForm' property='tekst.id' />">
						</logic:present>
							Koppeling   
						</a>
					</b>
		...
		<logic:present name="HulpmiddelenOverzichtForm" property="notities">
			<tr>
				<td valign="top">
					<b>
						<logic:present name="HulpmiddelenOverzichtForm" property="taalvraag">
							<a href="../do/initNotitiesInvoer?type=1&id=<bean:write name='HulpmiddelenOverzichtForm' property='taalvraag.id' />">
						</logic:present>
						<logic:present name="HulpmiddelenOverzichtForm" property="tekst">
							<a href="../do/initNotitiesInvoer?type=2&id=<bean:write name='HulpmiddelenOverzichtForm' property='tekst.id' />">
						</logic:present>							
							Notitie   
						</a>
					</b>
