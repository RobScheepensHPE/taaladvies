...
<table width="80%" border="0">
	<tr>
		<th><html:link page="/do/initBinnengekomenTaalvragen"><html:img page="/images/link_inbehandeling.gif" border="0" /></html:link></th>
		...
		<logic:notEqual name="Oproep_TaalvragenInvoerForm" property="oproep.id" value="0">
				<table cellspacing="5">					
					...
					<logic:iterate id="taalvragen" name="taalvragenbean" indexId="index">
						<tr>
							<td valign="top">
								<a href="../do/initBinnengekomenTaalvragenInvoer?parentId=<bean:write name="Oproep_TaalvragenInvoerForm" property="oproep.id" />&id=<bean:write name="taalvragen" property="id" />&ro=true<logic:equal name="Oproep_TaalvragenInvoerForm" property="adm" value="true">&adm=true</logic:equal>">
					...
					<tr>
						<td colspan="4" align="center">
							<a href="javascript:toeeigenen(<bean:write name="Oproep_TaalvragenInvoerForm" property="oproep.id" />,<bean:write name="Oproep_TaalvragenInvoerForm" property="oproep.eersteVraag.id"  />)" border="0""><img src="<html:rewrite page='/images/button_toeeigenen.gif' />" border="0" /></a>
						</td>
					</tr>							
